from browsertunnel.application import BrowserTab, BrowserTabNotFoundError, BrowserTabs
from browsertunnel.infrastructure.cdp_browser.active_target import (
    ActiveTarget,
    SelectTarget,
)
