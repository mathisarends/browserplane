...
class ApiErrorCode(StrEnum):
    ...
    AUTHENTICATION_PROFILE_NOT_FOUND = "authentication_profile_not_found"
    BROWSER_CHECKPOINT_NOT_FOUND = "browser_checkpoint_not_found"
    SESSION_REQUEST_NOT_FOUND = "session_request_not_found"
    SESSION_REQUEST_CONFLICT = "session_request_conflict"
    SESSION_REQUEST_TIMED_OUT = "session_request_timed_out"
